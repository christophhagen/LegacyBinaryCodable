...
final class StructEncodingTests: XCTestCase {
    ...
    func testDecodeDictionaryAsStruct() throws {
        ...
        let decoded: Test = try LegacyBinaryDecoder.decode(from: encoded)
    ...
    func testDecodeStructAsDictionary() throws {
        ...
        let decoded: [String: Int] = try LegacyBinaryDecoder.decode(from: encoded)
    ...
    func testDecodeKeyedContainerInSingleValueContainer() throws {
        ...
        let decodedWrapped: Wrapped = try LegacyBinaryDecoder.decode(from: encodedWrapped)
        ...
        let decodedWrapper: Wrapper = try LegacyBinaryDecoder.decode(from: encodedWrapper)
