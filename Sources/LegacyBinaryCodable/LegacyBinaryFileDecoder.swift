...
/**
 ...
 The class internally uses ``LegacyBinaryStreamDecoder`` to encode the individual elements,
 ...
 */
public final class LegacyBinaryFileDecoder<Element> where Element: Decodable {

    private let handle: FileHandle

    private let decoder: LegacyBinaryDecoder
     ...
     */
    public init(fileAt url: URL, decoder: LegacyBinaryDecoder = .init()) throws {
